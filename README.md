<h1 align="center">
  ...
  This is a Gym website where users can buy either "online coupons" for gym courses or some sport items like different kind of clothes and gear like jumpingropes or dumbbells. Users can purchase items anonymously or they can register and save their personal data. Also users can search for offers 
...
- Design
  ...
  - Imagery
    - Images are used for product images or as background images (i.e. landing page)
    - PNGs are used for keeping the disign a little more minimalistic without using much space (i.e. background img for login)
